...
export function FileChanges(): React.JSX.Element {
  ...
  const getStatusIcon = (status: string): React.JSX.Element => {
    switch (status) {
      ...
      case 'modified':
        return <FileEdit className="w-3 h-3 text-yellow-400" />
      case 'deleted':
        return <FileX className="w-3 h-3 text-red-400" />
      case 'staged':
        ...
        <div className="flex items-start gap-2">
          ...
          <div className="text-xs text-gray-300 leading-relaxed">
            ...
            <ul className="list-disc list-inside space-y-0.5 text-gray-400 ml-2">
              <li>
                <strong className="text-gray-300">Working Directory:</strong> Your modified files
              </li>
              <li>
                <strong className="text-gray-300">Staging Area (Index):</strong> Changes ready for
                commit
              </li>
              <li>
                <strong className="text-gray-300">Repository:</strong> Committed snapshots
              </li>
            </ul>
          </div>
        </div>
