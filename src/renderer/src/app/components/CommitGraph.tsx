...
const mockCommits: Commit[] = [
  { hash: 'a7f3c2e', message: 'Add user authentication', author: 'Alice', date: '2 hours ago', branch: 'main', parents: ['b4e5d1a'] },
  { hash: 'b4e5d1a', message: 'Update README.md', author: 'Bob', date: '5 hours ago', branch: 'main', parents: ['c8f2a3b'] },
  { hash: 'd9e1f4c', message: 'Feature: dark mode toggle', author: 'Alice', date: '6 hours ago', branch: 'feature/dark-mode', parents: ['c8f2a3b'] },
  { hash: 'c8f2a3b', message: 'Fix: navbar responsive issues', author: 'Charlie', date: '1 day ago', branch: 'main', parents: ['e2a4c7d'] },
  { hash: 'e2a4c7d', message: 'Initial commit', author: 'Alice', date: '3 days ago', branch: 'main', parents: [] },
];
    ...
    <div className="flex-1 bg-[#1e1e1e] p-4 overflow-auto">
      ...
      <div className="bg-blue-500/5 border border-blue-500/20 rounded p-3 mb-4">
        <div className="flex items-start gap-2">
          ...
          <div className="text-xs text-gray-300 leading-relaxed">
            <p className="mb-1">Each commit is a snapshot of your project. Commits form a directed acyclic graph (DAG) where:</p>
      ...
      <div className="space-y-1">
        {mockCommits.map((commit, index) => (
          <div key={commit.hash} className="flex items-start gap-3 hover:bg-white/5 p-2 rounded transition-colors">
