...
export function GitObjectsGuide(): React.JSX.Element {
  return (
      ...
      <div className="space-y-3 text-xs text-gray-300">
        <div className="flex items-start gap-2">
          ...
          <div>
            ...
            <p className="text-gray-400 leading-relaxed">
              Points to a tree (the file structure), parent commit(s), and stores author, timestamp,
              and message.
            </p>
          </div>
        </div>
        ...
        <div className="flex items-start gap-2">
          ...
          <div>
            ...
            <p className="text-gray-400 leading-relaxed">
              Represents a directory. Contains references to blobs (files) and other trees
              (subdirectories).
            </p>
          </div>
        </div>
        ...
        <div className="pt-2 border-t border-gray-700">
          ...
          <p className="text-gray-400 leading-relaxed mt-1 ml-5">
            Commit → Tree → Blob forms the core structure. Each object is content-addressable: its
            hash is computed from its content.
          </p>
        </div>
      </div>
    </div>
